...
const sellerRoutes: RouteObject[] = [
  ...
  { path: "/seller/fulfilment", ...lazy(() => import("@/features/sellers/pages/SellerFulfilment")) },
...
const adminRoutes: RouteObject[] = [
  ...
  { path: "/admin/logistics", ...lazy(() => import("@/features/logistics/pages/LogisticsOperationsPage")) },
